            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form class="form-inline">
                        ...
                        <h1><%=nom%></h1>
                        <a href="controlServicio?opc=6&id=<%=cli.getId_cli()%>">Mis Tours</a>
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Modifique los datos de los tours.<br>
                    Seleccione el Tour que desea</p>
               ...
               <tr><th>Id de Tour<th>Descripcion<th>Destino<th>Guia<th>Tarifa<th>Fecha de Inicio<th>Fecha de Finalización<th>Seleccionar
                        <%
                            for(Tours x:obj.lisResTours()){
                                ...
                                %>
                                <a href="controlServicio?opc=5&id=<%=x.getTour_id()%>">Seleccionar</a>
                                <%
                            }
                        %>
