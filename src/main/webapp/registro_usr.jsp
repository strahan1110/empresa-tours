...
<body class="bg-gradient-success">
	...
	<form action="controlUsuarios" id="id_form" class="user" method="POST">
			<input type="hidden" name="opc" value="1">
                        
                        <div class="form-group row">
			<div class="col-sm-6 mb-3 mb-sm-0">
                            <input class="form-control form-control-user" type="text" id="id_nombre" name="nom" placeholder="Ingrese el nombre">
			</div>
			<div class="col-sm-6">
                            <input class="form-control form-control-user" type="text" id="id_apellido" name="ape" placeholder="Ingrese el apellido">
			</div>
                            </div>
                        ...
                        <div class="form-group">
                            <input class="form-control form-control-user" type="text" id="id_correo" name="cor" placeholder="Ingrese su correo">
			</div>
                        
                         <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                            <input class="form-control form-control-user" type="date" id="id_nacio" name="nac"
            ...
            <hr>
                            <div class="text-center">
                                ¿Ya tienes una cuenta de admin?<a class="small" href="login_usr.jsp"><br>¡Inicia Sesión Admin!</a>
                            </div>
</div>
    </div>   </div>
            </div>
