...
<%
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="AdiUsuario.jsp">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="lisUsuario_usr.jsp">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  <tr><th>Id de Usuarios<th>Nombre<th>Apellido<th>DNI<th>Telefono<th>Correo<th>Password<th>Fecha de Nacimiento<th>Eliminar<th>Modificar
                        <%
                            for(Usuarios x:obj.lisUsuarios()){
